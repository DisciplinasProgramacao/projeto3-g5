...
public class Main {
    ...
    public static void entrarComoCliente(estacionamento1) {
    ...
    public static void menuCliente(estacionamento1){
        do{
    ...
    public static void estacionarVeiculo() {
        ...
        estacionamento1.estacionar(plaque);
    }

    public static void sairVeiculo() {
        System.out.println("Indique a placa do veiculo: ");
        String plaque = scanner.nextLine();
        estacionamento1.sair(plaque);
    }
